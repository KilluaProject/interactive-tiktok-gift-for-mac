...
connection.on("gift", (data) => {
  ...
  // // Gift untuk restart
  if (data.giftName.toLowerCase() === "perfume") {
    console.log("Menerima gift perfume , menekan tombol P, U, dan K.");
    setTimeout(() => {
  ...
  if (data.giftName.toLowerCase() === "finger heart") {
    console.log("Menerima gift finger heart, menekan tombol s selama 5 detik ");
