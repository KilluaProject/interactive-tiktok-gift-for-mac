...
connection.on("gift", (data) => {
  ...
  } else if (data.giftName.toLowerCase() === "perfume") {
    console.log("Menerima gift perfume, menekan tombol O selama 10 detik.");

    // Menekan tombol O dan tahan selama 10 detik
    robot.keyToggle("o", "down");
    console.log("Tombol O ditekan (down)");

    // Lepaskan tombol O setelah 10 detik
    setTimeout(() => {
      robot.keyToggle("o", "up");
      console.log("Tombol O dilepas (up)");
    }, 10000); // Tahan tombol "o" selama 10 detik
  }
});
